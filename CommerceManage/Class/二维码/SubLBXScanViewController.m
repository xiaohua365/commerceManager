...
//    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@",strResult.strScanned]];
//    [[UIApplication sharedApplication] openURL:url];

    
    [self signInWithMeetID:strResult.strScanned];
    
    [self.navigationController popViewControllerAnimated:YES];

}

#pragma mark - 扫描成功后进行签到请求
- (void)signInWithMeetID:(NSString *)ID {
    
    NSString *url = [NSString stringWithFormat:@"%@%@%@", URL_IP, PROJECT_NAME,MEETING_SIGNIN];
